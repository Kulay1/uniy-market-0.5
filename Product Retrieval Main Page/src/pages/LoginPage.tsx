...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // 模拟登录 API 调用 / Simulate login API call
    setTimeout(() => {
      setIsLoading(false);
      navigate('/');
    }, 1500);
  ...
  // 处理注册提交，跳转至邮箱验证页 / Handle register submit, redirect to email verification page
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // 模拟注册 API 调用，成功后跳转邮箱验证页 / Simulate register API call, then redirect to email verification
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      ...
      <div className="absolute top-8 left-8 right-8 flex items-center justify-between">
        ...
        {/* 语言切换下拉菜单 / Language switch dropdown */}
        <DropdownMenu>
                ...
                <form onSubmit={handleLogin}>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="email" type="text" placeholder="student@university.edu" required />
                    </div>
                    <div className="space-y-2">
              ...
              <CardContent>
                <form onSubmit={handleRegister}>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="student-id">{t('studentStaffId')}</Label>
                      <Input id="student-id" type="text" placeholder="STU123456" required />
                    </div>
                    <div className="space-y-2">
                    ...
                    {/* 校园认证说明 / Campus verification note */}
